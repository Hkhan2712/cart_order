<!-- resources/views/components/newsletter-banner.blade.php -->
<section>
  <div class="container-lg">
    <div class="bg-secondary text-light py-5 my-5" style="background: url('{{ asset('images/banners/banner-newsletter.jpg') }}') no-repeat; background-size: cover;">
      <div class="container">
